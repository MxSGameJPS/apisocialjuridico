export const openApiDocument = {
  ...
  info: {
    ...
    version: '0.2.0',
    description: 'API interna do Social Jurídico para busca, importação individual, importação em lote e atualização manual de processos judiciais via DataJud/CNJ, com resumo por IA.',
  },
  servers: [
  ...
  components: {
    ...
    schemas: {
      ...
      BuscarProcessoRequest: {
        ...
        properties: {
          numero_processo: { type: 'string', example: '1003394-43.2024.8.26.0394' },
        },
      },
      ...
      ImportarLoteRequest: {
        ...
        properties: {
          ...
          processos: {
            type: 'array',
            items: { type: 'string' },
            example: ['10033944320248260394', '1003394-43.2024.8.26.0394'],
          },
          cliente: { $ref: '#/components/schemas/PessoaCRM' },
          parte_contraria: { $ref: '#/components/schemas/PessoaCRM' },
        },
  ...
  paths: {
    ...
    '/health': {
      get: { tags: ['Sistema'], summary: 'Status da API', responses: { 200: { description: 'API online' } } },
    },
    ...
    '/api/processos/importar-lote': {
      post: {
        tags: ['Processos'],
        summary: 'Importar processos em lote',
        description: 'Recebe uma lista de CNJs, consulta o DataJud em sequência, evita duplicados quando configurado e retorna um relatório por processo.',
        security: [{ ApiKeyAuth: [] }],
    ...
    '/api/processos/atualizar': {
      post: {
        tags: ['Processos'],
        summary: 'Atualizar processo manualmente',
        description: 'Consulta novamente o DataJud, atualiza movimentações, resumo IA e metadados de sincronização.',
        security: [{ ApiKeyAuth: [] }],
    ...
    '/api/processos/atualizar-lote': {
      post: {
        tags: ['Processos'],
        summary: 'Atualizar processos em lote',
        security: [{ ApiKeyAuth: [] }],
